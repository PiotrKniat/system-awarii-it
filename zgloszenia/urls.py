...
urlpatterns = [
    ...
    path('przydziel/<int:pk>/', views.przydziel_zgloszenie, name='przydziel_zgloszenie'),
    path('moje-przydzielone/', views.moje_przydzielone_zgloszenia, name='moje_przydzielone_zgloszenia'),
